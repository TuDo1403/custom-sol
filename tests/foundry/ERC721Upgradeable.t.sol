...
} from "./utils/MockERC721Upgradeable.sol";

contract ERC721Recipient is ERC721TokenReceiverUpgradeable {
...
contract RevertingERC721Recipient is ERC721TokenReceiverUpgradeable {
    function onERC721Received(
        address,
        address,
        uint256,
...
contract WrongReturnDataERC721Recipient is ERC721TokenReceiverUpgradeable {
    function onERC721Received(
        address,
        address,
        uint256,
...
contract ERC721Test is DSTestPlus {
    ...
    function testBurn() public {
        ...
        hevm.expectRevert(IERC721Upgradeable.ERC721__NotMinted.selector);
        token.ownerOf(1337);
    }
