...
contract SSTORE2Test is DSTestPlus {
    function testWriteRead() public {
        ...
        address pointer = SSTORE2.writeToAddr(testBytes);
    ...
    function testWriteReadFullStartBound() public {
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 0),
            hex"11223344"
        );
    }
    ...
    function testWriteReadCustomStartBound() public {
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 1),
            hex"223344"
        );
    }
    ...
    function testWriteReadFullBoundedRead() public {
        ...
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(testBytes), 0, testBytes.length),
            testBytes
        );
    }
    ...
    function testWriteReadCustomBounds() public {
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 1, 3),
            hex"2233"
        );
    }

    function testWriteReadEmptyBound() public {
        SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 3, 3);
    }
    ...
    function testFailWriteReadOutOfStartBound() public {
        SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 41000);
    }

    function testFailWriteReadEmptyOutOfBounds() public {
        SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 42000, 42000);
    }

    function testFailWriteReadOutOfBounds() public {
        SSTORE2.read(SSTORE2.writeToAddr(hex"11223344"), 41000, 42000);
    }
    ...
    function testWriteRead(
        ...
        assertBytesEq(SSTORE2.read(SSTORE2.writeToAddr(testBytes)), testBytes);
    }
    ...
    function testWriteReadCustomStartBound(
        ...
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(testBytes), startIndex),
    ...
    function testWriteReadCustomBounds(
        ...
        assertBytesEq(
            SSTORE2.read(SSTORE2.writeToAddr(testBytes), startIndex, endIndex),
